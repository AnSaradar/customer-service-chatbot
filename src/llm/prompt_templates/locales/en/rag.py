...
system_prompt = Template("\n".join([
    ...
    "You can aplogize to the user if you are not able to reponse, or you couldn't find a suitable answer in the provided documents, in that case you should provide the user with the Customer Service Hotline $contact_phone and the Customer Service Email $contact_email"
